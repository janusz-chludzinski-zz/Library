...
public class WeatherInterceptor extends HandlerInterceptorAdapter{
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
        ...
        ResponseEntity<Weather> responseEntity = restTemplate.getForEntity("http://api.openweathermap.org/data/2.5/weather?q=Warszawa&appid=197d15f3cc9590316822e7894a6f1e40&units=metric", Weather.class);
